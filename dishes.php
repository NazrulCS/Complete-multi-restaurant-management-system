...
foreach ($_SESSION["cart_item"] as $item) {
    ...
    <div class="form-group row no-gutter">
        ...
        <div class="col-xs-4">
            ...
            <button class="btn btn-sm btn-secondary" onclick="updateCartItem(<?php echo $item["d_id"]; ?>, 'add')">+</button>
            <input class="form-control quantity-input" type="text" readonly value='<?php echo $item["quantity"]; ?>' id="example-number-input">
            <button class="btn btn-sm btn-secondary" onclick="updateCartItem(<?php echo $item["d_id"]; ?>, 'remove')">-</button>
        </div>
    </div>
    <?php
