...
if(isset($_POST['submit'] )) {
    ...
    else
    {
        ...
        elseif(!preg_match('/[a-z]/', $_POST['password']) || !preg_match('/[A-Z]/', $_POST['password'])) {
            echo "<script>alert('Password Must contain both lowercase and uppercase characters');</script>"; 
        }
                        ...
                        <div class="widget" >
                           <div class="widget-body">
							  ...
							  <form action="" method="post">
								 ...
								 <div class="cta">Already registered?<a href="login.php" style="color:#5c4ac7;"> Login here</a></div>
								 
								 
								 <div class="cta">Are you a restaurant Owner?<a href="restaurant_owner_register.php" style="color:#5c4ac7;"> Register here</a></div>
